...
/**
 * @type LivewellDataHasPartInner
 * Type
 * @export
 */
export type LivewellDataHasPartInner = LivewellContentElement | LivewellHealthTopicContent | LivewellVideoObject;

/**
* @type LivewellDataHasPartInnerClass
* @export
*/
export class LivewellDataHasPartInnerClass {
